#!/bin/bash
mkdir s3
aws s3 cp s3://devex-deploy/springboot-demo-app.zip /root/.jenkins/workspace/custom-actions/Sonarcopilot-app-test-5/s3
unzip s3/springboot-demo-app.zip -d /root/.jenkins/workspace/custom-actions/Sonarcopilot-app-test-5/s3
